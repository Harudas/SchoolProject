...
namespace WebApplication1.WebReference {
    ...
    public partial class WorkflowServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WorkflowServiceService() {
            this.Url = global::WebApplication1.Properties.Settings.Default.WebApplication1_WebReference_WorkflowServiceService;
        ...
        /// <remarks/>
        public void invokeProcessByOrgAsync(string pProcessPackageId, string pRequesterId, string pOrgUnitId, string pOrgId, string pFormDefOID, string pFormFieldValue, string pSubject) {
            this.invokeProcessByOrgAsync(pProcessPackageId, pRequesterId, pOrgUnitId, pOrgId, pFormDefOID, pFormFieldValue, pSubject, null);
        }
        
        /// <remarks/>
        public void invokeProcessByOrgAsync(string pProcessPackageId, string pRequesterId, string pOrgUnitId, string pOrgId, string pFormDefOID, string pFormFieldValue, string pSubject, object userState) {
        ...
        /// <remarks/>
        public void invokeProcessByOrg1Async(string pProcessPackageId, string pRequesterId, string pOrgUnitId, string pOrgId, string pSubject) {
            this.invokeProcessByOrg1Async(pProcessPackageId, pRequesterId, pOrgUnitId, pOrgId, pSubject, null);
        }
        
        /// <remarks/>
        public void invokeProcessByOrg1Async(string pProcessPackageId, string pRequesterId, string pOrgUnitId, string pOrgId, string pSubject, object userState) {
